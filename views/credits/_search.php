...
/* @var $model app\models\CreditsSearch */
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3">
                    <?=
                    $form->field($model, 'date1')->label('จากวันที่')->widget(
                            DatePicker::className(), [
                        'language' => 'th',
                        'options' => ['placeholder' => 'ช่วงวันที่รับหนี้ ...'],
                        'pluginOptions' => [
                            'format' => 'yyyy-mm-dd',
                            'todayHighlight' => true
                        ]
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                 ...
                 <div class="col-xs-2 col-sm-2 col-md-2">
                    <?= $form->field($model, 'pay_confirm')->checkboxList($model->getPay_confirm()) ?>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-3 col-sm-3 col-md-3">
